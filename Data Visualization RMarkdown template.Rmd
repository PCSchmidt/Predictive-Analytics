...
#output: beamer_presentation #beamer slideshow, you can comment out previous two lines to 'knit'   slides 
---
...
```{r}
cat(' Hello world!', '\n', 'This is XXX from Towson University.', '\n')
```
...
#m <- addTiles(m)
#m <- addMarkers(m, lng=-76.605949, lat=39.390572, popup="MATH 647, Towson University")
